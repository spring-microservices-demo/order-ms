...
public class CustomerStub {
	...
	public ResponseEntity<Customer> getById(@PathVariable("id") long id) {
		...
		return new ResponseEntity<Customer>(new Customer(42, "Mohandas",
				"Gandhi", "mkgandhi@gmail.com", "Banaras",
				"Gujarat"), HttpStatus.OK);
	}

	@RequestMapping(method = RequestMethod.GET)
	public PagedResources<Customer> getAll() {
		return new PagedResources<Customer>(Arrays.asList(new Customer(42,
				"Mohandas", "Gandhi", "mkgandhi@gmail.com",
				"Banaras", "Gujarat")), new PageMetadata(1, 0, 1));
	}
